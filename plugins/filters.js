...
const array = ['pewer','Wait','power','njan','Love','girls','Oh','Sad','Z','Ha','baby','Poda','Dreams','Come','Stay','Tu','Oo','Love u','Nokk','Kittanam','I love you','Nee','Yaa','Miss','Paavam','Mm','Move','Illa','Chi','girl','Money','Dam','Ooo','Seen','Ff','Kozhi','Aval','Piriya','Nanban','kozhi','Vaa','Me']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
...
const array = ['Ayyo','Da','Eee','Entha','Enthada','Good morning','Good night','Hai','Hi','Hy','Joker','Kurippe','Kurumb','Love','Mm','Ok','Poda','Pova','Power','Prince','Rashmika','Rudhra','Samantha','Save','Sed','Shoo','Smile','Sry','Udayipp','Vaa','Vannu','Vijay','achodaa','ayin','bot','broken','bye','chaya','cute','engane und','ithokke enth','ivan','joker','naanam','onam','paavam','poda','prince','rudhra','sed','sho','song','thalapathy','umma','vijay','༄PʀɪɴᴄEʳᶹᵈʰ࿐','Adi','anno','Bot','Cry','Da','Ennike','Entha','Ha','Haa','Happy','Hello','Hi','Hlo','Hm','I love u','I','Iam','Ka','Like','Love','Love u','mind','Mm','Oh','poocha','Sed','Tyre','Uff','Veno','You' ]
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
