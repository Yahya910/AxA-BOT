...
const array = ['1','Achuser','Adipoli','animal','anne','ano','Aval','Avale','avastha','Axa','Axe','Ayyo','baby','back','Bad','Boss','Bot','breakup','broken','care','chetta','Chi','chil','chunk','chunke','close','come','Cr7','Cristiano','dance','Devil','Dora','Dreams','Dude','Ee','ekk','enjoy','Entha cheyya','eshttam','eshttalla','evide','Feel aayi','feel','fek','ff','Frds','friend','girl','girls','good bye','group','gud mrng','Gud nyt','Ha','haha','hate','Hbd','Hehe','Hello','Hlo','Hloo','Hm','Hoi','Hy','I love you','I','illa','jd','Kadhal','Kar98','kattu kozhi','Kgf','kiss','Kozhi','kuch','Kukku','La be','la','Lala','Legend','life','line','Love u too','love u','Love you baby','Love','Loveu','loving','Lub u','machan','Malang','malik','malla','Mari','Mass','Me','Mention','Messi','mindalle','mindathe','mind','Miss','Mm','Money','Mood','moodesh','morning','Move','Music','muthe','My love','my','Mydhuz','mydhuzz','Myre','Nanba','nanban','Nanbiye','Nee','Neymar','Neymer','nine','Nirthada','Njan','njn','Njr','No','Oh','Ok bie','ok da','on','one','Oo','Ooo','over','Paat','padicho','pandaram','Paray','Pikachu','Pinnalla','Pinnallah','Pinne','Po','poda','poli','poliya','poova','pova','Power','power','Power varate','Poyi','Psycho','Rose','sad','Hai','Sarasu','Sarasuo','Sed aayi','Sed','Set aaka','set aano','Set','She','Sir','Smile','sneham','song','sorry','Stay','sulthan','Super','Tentacion','thayoli','Thera','theri','thug','Thyr','Town','Tu','Uff','Umbi','umma','Uyir','Va','Vaa','vathi','Veeran','yeah','you','menu','Z']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
